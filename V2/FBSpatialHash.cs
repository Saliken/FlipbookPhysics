...
{
    public class FBSpatialHash<T> where T : IFBSpatial
    {
        ...
        {
            var startX = item.AABB.Left / bucketDimension;
            var startY = item.AABB.Top / bucketDimension;  
            var endX = item.AABB.Right / bucketDimension;
            var endY = item.AABB.Bottom / bucketDimension;
